...
export class PortfolioService {
  ...
  getProjects(): Project[] {
    return [{
      ...
      projectURL: "https://openanthem.github.io/nimbus-docs/latest",
      repositoryURL: "https://github.com/openanthem/nimbus-core",
      ...
      title: "tonelope.com",
      projectURL: "http://tonelope.com",
      repositoryURL: "https://www.github.com/lopezton/tonelopedotcom",
      shortDescription: "My personal portfolio website.",
      longDescription: "One of my earliest projects used as a testing ground for several different front end programming languages. This project has primarily been a static website, written several different times using different styling themes and frameworks and in plain HTML, Native Javascript, jQuery, AngularJS. Today it is written in React. While most of the data today exists on my LinkedIn page, I like to have my own personal production deployed content where I can have a visible playground to show off. Someday I'll expand this project to include a blog, instructional content, etc... you know. When I get the time :)",
