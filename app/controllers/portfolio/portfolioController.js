myPortfolio.controller('portfolioCtrl', function($scope) {
	...
	$scope.projects = [{
		...
		longDescription: "After taking some time off from developing software to pursue my professional tennis aspirations, I returned to Xpanxion and began working with Anthem on an exciting new product. This new product was aimed at becoming the backbone for the replacement of a number of internal workflow applications as well as new applications within the organization. I joined the team after the initial design and implementation of the framework's lifecycle and after proving to be a capable developer in using the new framework, was asked to support the core development team in developing new features. I actively assisted in the creation of the CI/CD pipeline and established proven release strategy based on the Spring Framework's release, delivering over 30 successful releases of the framework. During various development iterations, I was asked to provide support to other engineers who were using the Nimbus framework to create applications by answering general questions and participating in peer programming. Given the amount of instruction needed, I decided to champion and create the framework's official documentation using AsciiDoc, writing 100+ pages of reference material and examples. During my time with Anthem, I had supported at least six different production deployed applications that were using the Nimbus Framework.",
